  ...
  return (
    <>
      <Head>
        ...
        <meta
          content="Made by Rana Rabees (Post Modern Full Stack Applications Developer and Architect)"
          name="description"
        />
      ...
      <div className="container">
        <p className="container-title">NFT Marketplace Dapp Made by Rana Rabees</p>
        <h3 className=" container-description">Click Below to connect wallet!</h3>
        <div className="Button">
          <ConnectButton />

        </div>
        <div className="gradient-cards">
          <Link href="https://goerli.etherscan.io/address/0xeED4485ECA3F64b16fB5cf05F4C6441A7B7cBCCd" className="card">
            <div className="container-card bg-green-box">
              ...
              <p className="card-title">1- Smart contract, simple transactions &rarr;</p>
              <p className="card-description">1- Smart contract, simple transactions &rarr;</p>
            </div>
          </Link>

          <Link href="https://mumbai.polygonscan.com/address/0xaf14c247d1072ae2621057cc649d9229346c5957#tokentxnsErc721" className="card">
            <div className="container-card bg-white-box">
              ...
              <p className="card-title">2- Mint NFTs &rarr;</p>
              <p className="card-description">1-2 and Bundle NFTs transactions at a time.</p>
            </div>
          </Link>

          <Link href="https://goerli.etherscan.io/address/0xD01610E588123c9B18aa7314A3a8701054f9A45c" className="card">
            <div className="container-card bg-blue-box">
              ...
              <p className="card-title">4- Recent transactions on etherscan&rarr;</p>
              <p className="card-description">Some transactions related to these assignments.</p>
            </div>
          </Link>
          ...
          <div className="card">
            <div className="container-card bg-yellow-box">
              ...
              <p className="card-title">3- Create wallet social with RainbowKit&rarr;</p>
              <p className="card-description">Click on the CONNECT WALLET button.</p>
            </div>
          </div>
        </div>
        {/* <div className="gradient-cards">
